...
public class FormFila extends javax.swing.JFrame {
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnMostraInvertida, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnAddFirstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddFirstActionPerformed
        ...
        if(txtNome.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Insira um valor para Nome");
        }else if(txtRG.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Insira um valor para RG");
        }else if(txtIdade.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Insira um valor para Idade");
        }else{
    ...
    private void btnMostraInvertidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostraInvertidaActionPerformed
        Iterator meuIterator = minhaDeque.descendingIterator();
        if(!minhaDeque.isEmpty()){
            if(btnMostraInvertida.getText().equals("Mostrar invertida")){
                listFilaDupla.setText("");
                mostraInvertido();
                btnMostraInvertida.setText("Voltar inversão");
            }else if(btnMostraInvertida.getText().equals("Voltar inversão")){
                listFilaDupla.setText("");
                mostra();
                btnMostraInvertida.setText("Mostrar invertida");
            }
